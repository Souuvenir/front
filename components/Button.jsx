export function ButtonDefault({ buttonText }) {
  return <button
            ...
            className="inline-block rounded
              ...
              dark:bg-neutral-900 dark:shadow-[0_4px_9px_-4px_#030202]
              ...
              dark:active:bg-neutral-900 dark:active:shadow-[0_8px_9px_-4px_rgba(3,2,2,0.3),0_4px_18px_0_rgba(3,2,2,0.2)] mr-2"
            >
            {buttonText}
        </button>
}